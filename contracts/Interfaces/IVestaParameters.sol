...
interface IVestaParameters {
	...
	// Bonus for SP depositors on liquidation
	function BONUS(address _collateral) external view returns (uint256);
	...
	function setBONUS(address _asset, uint256 newBONUS) external;
