...
contract('TroveManager', async accounts => {
  ...
  */
  ...
  /* ABDK64, no error correction:
    ...
    VSTDebt left in Default Pool is: 108
    ...
    VSTDebt left in Default Pool is: 653
  */
  ...
  /* ABDK64, no error correction:
    ...
    VSTDebt left in Default Pool is: 75 
  ...
  */
  ...
  /* ABDK64, no error correction:
    ...
    VSTDebt left in Default Pool is: 180 
  ...
  */
  ...
  it("11 accounts. 10 liquidations. Check (ActivePool - DefaultPool) differences", async () => {
    ...
    for (account of accounts.slice(1, 11)) {
      ...
      const defaultPoolUSDVDebt = await defaultPool.getVSTDebt()
    ...
    console.log(`Accumulated VSTDebt difference between Active and Default Pools is: ${totalUSDVDebtPoolDifference}`)
  })

  /* ABDK64, no error correction
    Accumulated ETH difference between Default and Active Pools is: 0
    Accumulated VSTDebt difference between Active and Default Pools is: 0
  ...
  */
  ...
  it("11 accounts. 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
    ...
    const L_VSTDebt = await troveManager.L_VSTDebt()
    ...
    const totalUSDVRewards = (totalColl.mul(L_VSTDebt)).div(_1e18_BN)
    ...
    console.log(`VSTDebt difference between total pending rewards and DefaultPool: ${USDVDebtRewardDifference} `)
  })

  /* ABDK64, no error correction:
    ETH difference between total pending rewards and DefaultPool: 700
    VSTDebt difference between total pending rewards and DefaultPool: 800

    ABDK64 WITH correction:
    ETH difference between total pending rewards and DefaultPool: 300
    VSTDebt difference between total pending rewards and DefaultPool: 400
    
    DeciMath, no error correction:
    ETH difference between total pending rewards and DefaultPool: -100
    VSTDebt difference between total pending rewards and DefaultPool: -200

    Pure division with correction: 
    ETH difference between total pending rewards and DefaultPool: 0
    VSTDebt difference between total pending rewards and DefaultPool: 0
  */
  ...
  /* ABDK64, no error correction:
    ...
    VSTDebt difference between total pending rewards and DefaultPool: 55000
    
    ABDK64 WITH correction:
    ETH difference between total pending rewards and DefaultPool: 31000
    VSTDebt difference between total pending rewards and DefaultPool: 31000

    DeciMath, no error correction:
    ETH difference between total pending rewards and DefaultPool: 2000
    VSTDebt difference between total pending rewards and DefaultPool: -2000
  ...
  */
  ...
  it("11 accounts with random ETH and proportional VST (180:1). 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
    await borrowerOperations.openTrove(0, 0, accounts[999], { from: accounts[999], value: dec(100, 'ether') })

    await th.openTrove_allAccounts_randomETH_ProportionalVST(1, 2, accounts.slice(0, 11), contracts, 180)
  ...
  /* ABDK64, no error correction:
    ...
    VSTDebt difference between total pending rewards and DefaultPool: 8000

    ABDK64 WITH correction:
    ETH difference between total pending rewards and DefaultPool: 300
    VSTDebt difference between total pending rewards and DefaultPool: 300
    ...
    Pure division with correction:
    ETH difference between total pending rewards and DefaultPool: 100
    VSTDebt difference between total pending rewards and DefaultPool: 100
  */

  it("101 accounts with random ETH and proportional VST (180:1). 100 liquidations. Check 1) (DefaultPool - totalDistributionRewards) difference, and 2) ", async () => {
    await borrowerOperations.openTrove(0, 0, accounts[999], { from: accounts[999], value: dec(1000, 'ether') })

    await th.openTrove_allAccounts_randomETH_ProportionalVST(1, 2, accounts.slice(0, 101), contracts, 180)
  ...
  /* ABDK64, no error correction:
    ...
    VSTDebt difference between total pending rewards and DefaultPool: 61000

    ABDK64 WITH correction:
    ETH difference between total pending rewards and DefaultPool: 31300
    VSTDebt difference between total pending rewards and DefaultPool: 30000
    ...
    VSTDebt difference between total pending rewards and DefaultPool: 1000
  */
  ...
  it("11 accounts. 10 liquidations, partial offsets. Check (DefaultPool - totalRewards) differences", async () => {
    // Acct 99 opens trove with 100 VST
    await borrowerOperations.openTrove(0, 0, accounts[99], { from: accounts[99], value: dec(100, 'ether') })
    await borrowerOperations.withdrawVST(0, dec(100, 18), accounts[99], { from: accounts[99] })
    ...
    // On loop: Account[99] adds 10 VST to pool -> a trove gets liquidated and partially offset against SP, emptying the SP
    for (account of accounts.slice(1, 11)) {
    ...
    const totalUSDVRewards_Distribution = (totalColl.mul(L_VSTDebt)).div(_1e18_BN)
    ...
    console.log(`VSTDebt difference between total pending distribution rewards and DefaultPool: ${USDVDebtRewardDifference} `)
  })

  /* ABDK64, no error correction
    ETH difference between total pending distribution rewards and DefaultPool: 550
    VSTDebt difference between total pending distribution rewards and DefaultPool: 600
    
    DeciMath, no error correction:
    ETH difference between total pending distribution rewards and DefaultPool: 150
    VSTDebt difference between total pending distribution rewards and DefaultPool: -200
    
    Pure division with error correction:
    ETH difference between total pending distribution rewards and DefaultPool: 50
    VSTDebt difference between total pending distribution rewards and DefaultPool: 0
  */

  it("101 accounts. 100 liquidations, partial offsets. Check (DefaultPool - totalRewards) differences", async () => {
    // Acct 99 opens trove with 100 VST
    await borrowerOperations.openTrove(0, 0, accounts[999], { from: accounts[999], value: dec(100, 'ether') })
    await borrowerOperations.withdrawVST(0, dec(100, 18), accounts[999], { from: accounts[999] })
  ...
  /* ABDK64, no error correction
    ...
    VSTDebt difference between total pending distribution rewards and DefaultPool: 8900
  ...
  */
  ...
  it("11 accounts. 10 Borrowers add to SP. 1 liquidation, 10 Borrowers withdraw all their SP funds", async () => {
    ...
    /* Sometimes, the error causes the last VST withdrawal from SP to underflow and fail. 
    ...
    const SP_USDV = await stabilityPool.getTotalVSTDeposits()
    ...
    console.log(`VST insufficiency in Stability Pool is ${SP_USDV_Insufficiency}`)
  })

  /* ABDK64, no error correction
     Sometimes subtraction overflows on last withdrawal from SP - error leaves insufficient VST in Pool.
     ...
     VST insufficiency in Stability Pool is 530
     
     DeciMath, no error correction:
     Surplus ETH left in in Stability Pool is 0
     VST insufficiency in Stability Pool is 0
  ...
  /* ABDK64, no error correction
   ...
   VST insufficiency in Stability Pool is 5300
  ...
  */
  ...
  it("11 accounts. 10 Borrowers add to SP, random VST amounts. 1 liquidation, 10 Borrowers withdraw all their SP funds", async () => {
    // Acct 99 opens trove with 100 VST
    await borrowerOperations.openTrove(0, 0, accounts[999], { from: accounts[999], value: dec(100, 'ether') })
    await borrowerOperations.withdrawVST(0, dec(100, 18), accounts[999], { from: accounts[999] })
  ...
  /* ABDK64, no error correction
     ...
     VST insufficiency in Stability Pool is 442
     ...
     VST insufficiency in Stability Pool is 67

     Pure division with error correction:
     Surplus ETH left in in Stability Pool is 446
     VST insufficiency in Stability Pool is 507
   */

  it("101 accounts. 100 Borrowers add to SP, random VST amounts. 1 liquidation, 100 Borrowers withdraw all their SP funds", async () => {
    // Acct 99 opens trove with 100 VST
    await borrowerOperations.openTrove(0, 0, accounts[999], { from: accounts[999], value: dec(100, 'ether') })
    await borrowerOperations.withdrawVST(0, dec(100, 18), accounts[999], { from: accounts[999] })
  ...
  /* ABDK64, no error correction
   ...
   VST insufficiency in Stability Pool is 1112

   DeciMath, no error correction:
   Surplus ETH left in in Stability Pool is 1373
   VST insufficiency in Stability Pool is -13

   Pure division with no error correction:
   Surplus ETH left in in Stability Pool is 4087
   VST insufficiency in Stability Pool is 1960

   Pure division with error correction:
   Surplus ETH left in in Stability Pool is 3072
   VST insufficiency in Stability Pool is 452
 */

  it("501 accounts. 500 Borrowers add to SP, random VST amounts. 1 liquidation, 500 Borrowers withdraw all their SP funds", async () => {
    // Acct 99 opens trove with 100 VST
    await borrowerOperations.openTrove(0, 0, accounts[999], { from: accounts[999], value: dec(100, 'ether') })
    await borrowerOperations.withdrawVST(0, dec(100, 18), accounts[999], { from: accounts[999] })
  ...
  /* ABDK64, no error correction:
    ...
    VST insufficiency in Stability Pool is -8445

    Pure division, no correction:
    Surplus ETH left in in Stability Pool is 18708
    VST insufficiency in Stability Pool is 25427

    Pure division with error correction:
    Surplus ETH left in in Stability Pool is 1573
    VST insufficiency in Stability Pool is 6037
  */
  ...
  it("10 accounts. 10x liquidate -> addColl. Check stake and totalStakes (On-chain data vs off-chain simulation)", async () => {
    ...
    let offchainTotalStakes = await troveManager.totalStakes(ZERO_ADDRESS)
    ...
    for (i = 1; i < 10; i++) {
      ...
      const totalStakes = await troveManager.totalStakes(ZERO_ADDRESS)
  ...
  */
  ...
  /* DeciMath:
    ...
    VSTDebt left in Default Pool is: 308731912
  
    Pure division, correction:
    ETH left in Default Pool is: 1136050360
    VSTDebt left in Default Pool is: 997601870
  
    Pure division, no correction:
    ETH left in Default Pool is: 810899932
    VSTDebt left in Default Pool is: 535042995
  */
  ...
  /*
   ...
   VSTDebt left in Default Pool is: 14696382412
 
   Pure division, correction:
   ETH left in Default Pool is: 9281255535
   VSTDebt left in Default Pool is: 5854012464
   */
  ...
  it("11 accounts with random ETH and proportional VST (180:1). 10 liquidations. Check (DefaultPool - totalRewards) differences", async () => {
    ...
    // Troves open with 100-200 million ether and proportional VST Debt
    await th.openTrove_allAccounts_randomETH_ProportionalVST(100000000, 200000000, accounts.slice(0, 11), contracts, 180)
  ...
  /* 
    ...
    VSTDebt difference between total pending rewards and DefaultPool: 12000000000
  
    Pure division with correction:
    ETH difference between total pending rewards and DefaultPool: 1000000000
    VSTDebt difference between total pending rewards and DefaultPool: 1000000000
    */
  ...
  it("101 accounts with random ETH and proportional VST (180:1). 100 liquidations. Check 1) (DefaultPool - totalDistributionRewards) difference, and 2) ", async () => {
    ...
    // Troves open with 100-200 million ether and proportional VST Debt
    await th.openTrove_allAccounts_randomETH_ProportionalVST(100000000, 200000000, accounts.slice(0, 101), contracts, 180)
  ...
  /*
    ...
    VSTDebt difference between total pending rewards and DefaultPool: 870000000000

    Pure division with correction:
    ETH difference between total pending rewards and DefaultPool: 10000000000
    VSTDebt difference between total pending rewards and DefaultPool: 10000000000
  */
})
...
1) Reward applications accumulate ETH and VSTDebt error in DefaultPool

2) Liquidations accumulate ETH and VSTDebt error in DefaultPool
...
5) StabilityPool Withdrawals can accumulate VSTLoss in the StabilityPool (i.e. they distribute too much VST), and can block
